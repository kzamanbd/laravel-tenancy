<div class="card-body">
    ...
    <form wire:submit="login" class="my-3">
        ...
        <div class="block">
            ...
            <input id="email" type="email" name="email" wire:model="email" class="form-control"
                placeholder="{{ __('Email Address') }}" autocomplete="email" required autofocus />
            @error('email')
        ...
        <div class="mb-4 flex items-center justify-between">
            <label class="inline-flex items-center">
                ...
                <span class="ms-3 text-sm">{{ __('Remember me') }}</span>
            </label>
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-primary w-full">{{ __('Sign in to your account') }}</button>
    </form>
    ...
    @if (Route::has('register'))
        <p class="text-sm">
            ...
            <a href="{{ route('register') }}" wire:navigate class="text-primary">{{ __('Sign up here') }}</a>
        </p>
    @endif
</div>
