<div class="card-body">
    ...
    <!-- Welcome Message -->
    <div class="my-3">
        <p class="mb-2 hidden text-2xl font-semibold md:block">Join the adventure</p>
        <p class="text-xs">Create your account and start your journey with us</p>
    </div>
    ...
    <div class="my-6 flex items-center gap-4">
        <button class="btn btn-light w-full p-2 lg:w-1/2">
            ...
            <span class="hidden md:block">Sign up with Google</span>
        </button>
        ...
        <button class="btn btn-light w-full p-2 lg:w-1/2">
            ...
            <span class="hidden md:block">Sign up with Apple</span>
        </button>
    </div>
    ...
    <!-- Registration Form -->
    <form wire:submit="register" class="my-3">
        <!-- Name -->
        <div class="block">
            <label for="name" class="form-label">{{ __('Name') }}</label>
            <input id="name" type="text" name="name" wire:model="name" class="form-control"
                placeholder="{{ __('Full name') }}" autocomplete="name" required autofocus />
            @error('name')
        ...
        <div class="my-2">
            ...
            <div class="relative">
                ...
                <button type="button"
                    ...
                    <svg class="size-3.5 shrink-0 dark:text-gray-200" width="24" height="24" viewBox="0 0 24 24"
        ...
        <!-- Subdomain -->
        <div class="my-2">
            <label for="subdomain" class="form-label">{{ __('Subdomain') }}</label>
            <div class="input-group">
                <input id="subdomain" type="text" name="subdomain" wire:model="subdomain" class="form-control"
                    placeholder="{{ __(key: 'yourcompany') }}" required />
                <div class="input-group-append">
                    <select wire:model.live="baseDomain" class="form-control bg-transparent">
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-primary w-full mt-4">{{ __('Create account') }}</button>
    </form>
