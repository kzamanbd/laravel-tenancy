<div class="flex flex-col gap-6">
    ...
    <form wire:submit="register" class="flex flex-col gap-6">
        ...
        <!-- Subdomain -->
        <div>
            <flux:label for="subdomain">{{ __('Subdomain') }}</flux:label>
            <div class="flex w-full">
                <flux:input wire:model="subdomain" id="subdomain" class="block rounded-r-none" type="text"
                ...
                <div
                    ...
                    <select wire:model.live="baseDomain">
