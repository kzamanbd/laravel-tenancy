            ...
            <ul class="tw-nav-menu hs-accordion-group">
                ...
                <li class="tw-menu-item hs-accordion">
                    <button type="button" class="tw-menu-link hs-accordion-toggle">
                        <span class="icon-[mdi--view-dashboard-outline]"></span>
                        <span class="tw-link-label">
                            Dashboard
                            <span class="badge menu-badge"> 10 </span>
                        </span>
                        <span class="tw-arrow">
                    ...
                    <ul class="hs-accordion-content twd--menu">
                        <li class="twd--menu-item">
                            <a href="{{ route('dashboard') }}" class="twd--link"> Overview </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/analytics.html" class="twd--link"> Analytics </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/crypto.html" class="twd--link"> Crypto </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/crm.html" class="twd--link"> CRM </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/hrm.html" class="twd--link"> HRM </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/jobs.html" class="twd--link"> Jobs </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/courses.html" class="twd--link"> Courses </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/projects.html" class="twd--link"> Projects </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/dashboard/ecommerce.html" class="twd--link"> ECommerce </a>
                        </li>
                    </ul>
                </li>
                <!-- dashboard end -->
                ...
                <li class="tw-menu-header">
                    ...
                    <span class="label">USER AND PAGES</span>
                </li>


                <!-- page header end -->
                <li class="tw-menu-item">
                    <a href="/pages/icons.html" class="tw-menu-link">
                        <span class="icon-[mdi--shape-outline]"></span>
                        <span class="tw-link-label">Icons</span>
                    </a>
                </li>
                ...
                <li class="tw-menu-item hs-accordion">
                    <button type="button" class="tw-menu-link hs-accordion-toggle">
                        ...
                        <span class="tw-link-label">Account</span>
                        <span class="tw-arrow">
                            <i class="icon-[mdi--chevron-down]"></i>
                        </span>
                    </button>

                    <ul class="twd--menu hs-accordion-content">
                        <li class="twd--menu-item">
                            <a href="/pages/account/overview.html" class="twd--link"> Overview </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/account/notification.html" class="twd--link"> Notification </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/account/integrations.html" class="twd--link"> Integrations </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/account/preferences.html" class="twd--link"> Preferences </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/account/workspace.html" class="twd--link"> Workspace </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/account/billing.html" class="twd--link"> Plan & Billing </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/account/teams.html" class="twd--link"> Teams </a>
                        </li>
                        <li class="twd--menu-item">
                            <a href="/pages/api-keys.html" class="twd--link"> API Keys </a>
                        </li>
                    </ul>
                </li>
                <!-- user profile end -->
        ...
        <div class="hs-dropdown footer-menu-dropdown [--auto-close:inside] [--placement:top-right]">
            <button type="button" class="hs-dropdown-toggle footer-menu-icon group">
                ...
                <span class="app-switcher-label">
                    <div>
                        <span class="hs-dropdown-open:text-primary block text-sm font-bold dark:text-neutral-200">
                            GitHub
                        </span>
                        <span class="block text-xs dark:text-neutral-500"> github.io </span>
                    </div>
                    <svg class="hs-dropdown-open:text-primary ms-auto size-4 shrink-0"
            ...
            <div class="hs-dropdown-menu dropdown-menu">
                <button class="tw-nav-footer-item group active">
                ...
                <div class="item-group-divider"></div>
                <button class="tw-nav-footer-item group flex justify-between">
                    <span>Sign out</span>
                    <span class="text-xs">demo@github.io</span>
                </button>
            </div>
        </div>
    </div>
