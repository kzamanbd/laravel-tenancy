...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
            ...
            <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
                ...
                <flux:tooltip :content="__('Repository')" position="bottom">
                    <flux:navbar.item class="h-10 max-lg:hidden [&>div>svg]:size-5" icon="folder-git-2"
                        href="https://github.com/kzamanbd/laravel-tenancy" target="_blank" :label="__('Repository')" />
                </flux:tooltip>
        ...
        <flux:sidebar stashable sticky
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="folder-git-2" href="https://github.com/kzamanbd/laravel-tenancy"
                    target="_blank">
                    {{ __('Repository') }}
                </flux:navlist.item>
